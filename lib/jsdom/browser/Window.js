...
function Window(options) {
  ...
  this.setTimeout = function (fn, ms) {
    ...
    return startTimer(window, setTimeout, clearTimeout, fn, ms, args);
  };
  this.setInterval = function (fn, ms) {
    ...
    return startTimer(window, setInterval, clearInterval, fn, ms, args);
  };
...
function startTimer(window, startFn, stopFn, callback, ms, args) {
